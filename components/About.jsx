  ...
  return (
    <div id="about" className="about-container d-flex flex-column justify-content-center align-items-center">
      ...
      <p className='about-text'>
        Hello! I'm Bilal Khan, a back-end developer with a keen interest in creating efficient and innovative solutions. I’m currently studying at Folsom Lake College and planning to transfer next year to pursue a master’s in computer engineering. My goal is to develop programs that drive technological advancement and benefit others.<br /><br />
